...
fin:= false;
   ...
   if      (juego.tablero.celdas[fila,columna].estado = OCULTA) AND
       NOT (juego.tablero.celdas[fila,columna].tieneBomba)      AND
           (EsPosicionValida(juego,fila,columna))               then begin
